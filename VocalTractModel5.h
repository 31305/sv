 ...
 ***************************************************************************/
// This file was copied from GamaTTS and modified. 
...
VocalTractModel5<TFloat, SectionDelay>::loadConfiguration()
{
	...
	config_.temperature          = 35;
	config_.lossFactor           = 0.4;
	config_.modulation           = 1;
	config_.mixOffset            = 48;
	const TFloat globalRadiusCoef      = 1;
	const TFloat globalNasalRadiusCoef = 1;
	config_.nasalRadius[NR1]     = 0.0;
	config_.nasalRadius[NR2]     = 1.35 * globalNasalRadiusCoef;
	config_.nasalRadius[NR3]     = 1.83 * globalNasalRadiusCoef;
	config_.nasalRadius[NR4]     = 1.94 * globalNasalRadiusCoef;
	config_.nasalRadius[NR5]     = 1.72 * globalNasalRadiusCoef;
	config_.nasalRadius[NR6]     = 1.30 * globalNasalRadiusCoef;
	config_.nasalRadius[NR7]     = 0.73 * globalNasalRadiusCoef;
	config_.radiusCoef[R1]       = 1.0 * globalRadiusCoef;
	config_.radiusCoef[R2]       = 1.0 * globalRadiusCoef;
	config_.radiusCoef[R3]       = 1.0 * globalRadiusCoef;
	config_.radiusCoef[R4]       = 1.0 * globalRadiusCoef;
	config_.radiusCoef[R5]       = 1.0 * globalRadiusCoef;
	config_.radiusCoef[R6]       = 1.0 * globalRadiusCoef;
	config_.radiusCoef[R7]       = 1.0 * globalRadiusCoef;
	config_.radiusCoef[R8]       = 1.0 * globalRadiusCoef;
	config_.glottalNoiseCutoff   = 400;
	config_.fricationNoiseCutoff = 5500;
	config_.fricationFactor      = 1;
	config_.minGlottalLoss       = 0;
	config_.maxGlottalLoss       = 2;
	config_.glottalLowpassCutoff = 4000;
	config_.bypass               = 0;

	logParameters_ = interactive_ ? false : false; 
}

template<typename TFloat, unsigned int SectionDelay>
void
VocalTractModel5<TFloat, SectionDelay>::reset()
{
...
template<typename TFloat, unsigned int SectionDelay>
void
VocalTractModel5<TFloat, SectionDelay>::execSynthesisStep()
{
...
template<typename TFloat, unsigned int SectionDelay>
void
VocalTractModel5<TFloat, SectionDelay>::setParameter(int parameter, float value)
{
	switch (parameter) {
...
template<typename TFloat, unsigned int SectionDelay>
void
VocalTractModel5<TFloat, SectionDelay>::finishSynthesis()
{
	srConv_->flushBuffer();
}
