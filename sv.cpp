...
{{.nsv=1},
	...
	{.vm=vs({31,51,4,55,51,32,70,3,49,4,55,52,43,4,55,51,1,70,7,51,43,4,71,66,8,77}),.nv=4,.pv=6,.vv={3}},
	{.vm=vs({68,46,43,1,55,51,32,70,1,71,1,44,11,51,48,3,65,1,75}),.nv=4,.pv=8,.vv={3}},
