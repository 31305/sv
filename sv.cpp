...
{{.nsv=1},
	...
	{.vm=vs({70,1,46,1,71,44,1,47,70,1,43,1,70,66,44,2,49,43,3,70,7,44,75,5,65,3,76,51,44,7,43,31,66,1}),.nv=18},
	{.vm=vs({4,68,8,75,3,77,71,44,1,47,70,2,77,51,2,49,43,6,66}),.nv=18},
	{.vm=vs({49,1,44,46,1,71,44,1,67,1,75,2,76,51,3,44,1,43,1,70,66,44,2,76,51,44,33,66,1,46,43,3,75}),.nv=18},
	{.vm=vs({2,67,3,46,4,70,7,44,75,4,66,1,46,43,3,75}),.nv=38},
	{.vm=vs({66,32,70,3,49,1,75,71,1,44,51,2,77,51,1,67,2,76,51,3,44,7,48,43,1,66,31}),.nv=39},
	{.vm=vs({2,65,18,70,4,76,58,5,66,3,43,37,68,46,7,47,1,66,2,76,48,2,61,71,3,60,56,4,47,1,56,56,1}),.nv=18},
	{.vm=vs({46,7,69,41,73,1,50,2,46,38,65,3,46,1,77}),.nv=41},
	{.vm=vs({13,66,71,4,68,32,71,9}),.nv=42},
