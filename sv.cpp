...
{{.nsv=1},
	...
	{.vm=vs({2,75,9,66,1,47,56,1,71,10,43,17,48,3,47,56,1}),.nv=98},
	{.vm=dn(166),.nsv=1},
	{.vm=vs({1,71,1,44,4,50,65,32}),.nv=100,.nsv=1,.rv=1},
	{.vm=vs({71,1,48,61,1,51,2,76,68,3,68,4,66,7}),.nv=101,.rv=1},
	{.vm=vs({51,2,49,43,3,56,7,68,2,71,9,46,31,52,1,49,1,55,53,44,1,50,2,49,43,3,46,19,66,66,7,75,5,44,53,3,65,4,43,1,66,2,70,66,44,3,76,49,43,4,66}),.nv=18,.pv=104},
	{.vm=vs({51,5,70,5,75,1,46,20,66,66,9,77,49,43,4,66}),.nv=103},
	{.vm=dn(167),.nsv=1,.rv=1},
	{.vm=vs({13,71,5,49,3,70,1,76,70,8,53,21,50,10,66,1,76,66,2,44,15,60,31,70,1}),.nv=105,.rv=1},
	{.vm=vs({70,7,48,61,1,44,51,43,33,60,1,73,1,45,1,71,1,44,10,51,48,5}),.nv=105,.rv=1},
	{.vm=vs({}),.nsv=1},
};//lsn
