...
{{.nsv=1},
	...
	{.vm=vs({70,1,46,1,71,44,1,47,70,1,43,1,70,66,44,2,49,43,3,70,7,44,75,5,65,3,76,51,44,7,43,31,66,1}),.nv=18,.nsv=1},
	{.vm=vs({4,68,8,75,3,77,71,44,1,47,70,2,77,51,2,49,43,6,66}),.nv=18,.nsv=1},
	{.vm=vs({66,2,56,56,9,70,66,2,70,12,43,1,75}),.nv=37,.nsv=1},
	{.vm=vs({}),.nsv=1},
};
