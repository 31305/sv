...
{{.nsv=1},
	...
	{.vm=vs({2,71,10,68,2,76,49,2,44,46,1,76,51,4,45,71,1,70,4,51,2,75})},
	...
	{.vm=vs({2,66,3,46,4,70,43,35,44,58,2,70,36,75,51,4,44,2,43,3,66,4,75}),.nv=47,.pv=49},
	{.vm=vs({13,74,1,43,2,67,6,51,44,7,43,1,75,4,65,31,51,2,47,56,9,68,46,7,69,8,44,9,48,43,1,66,31,43,32,70,3,51,25,66,2,50,43,3,43,1,70,66,44,2,50,43,3,50,4,55,52,43,4,66,75,1,51,2,76,53,15,65,1,46,1,66,66,4,70,7,44,69,4,43,1,65,2,76,51,44,7,43,32,66,3}),.nv=48,.pv=50},
	{.vm=vs({50,2,43,6,70,66,44,7,51,38,46,6,74,1,44,32,70,75,6,70,1,46,10,43,38,46,6}),.nv=49},
	{.vm=vs({}),.nsv=1},
};
std::vector<v> sk()
{
