...
std::vector<v> dn(int32_t k)
{
	...
	if(k==265)
		return vs({71,1,60,56,1,48,1,48,43,1,69,7,51,1,68,46,7,47,1,66,2,66,3,75,31,53,36,44,37,66,66,1,44,32,50,3,70,7});
...
{{.nsv=1},
	...
	{.vm=vs({68,31,47,1,74,4,48,5,76,46,5,56,3,43,7,66,13,76,46,7,69,8,44,74,3,46,31,66}),.pv=155,.sv=1},
	{.vm=vs({58,1,45,1,66,1,70,66,44,2,76,51,44,9,43,1,66,4,75})},
	{.vm=vs({2,67,3,46,4,70,35,46,2,45,9,52,43,1,66,4,75}),.nv=153},
	{.vm=vs({}),.nsv=1},
};//lsn
