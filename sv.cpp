...
{{.nsv=1},
	...
	{.vm=vs({14,71,3,50,1,49,1,66,7,51,2,49,43,6,47,56,7,66,51,2,46,71,3,70,4,43,4,77,49,75,2,44,3,65,31,70,1}),.nv=59,.rv=1},
	{.vm=dn(156),.nsv=1,.rv=1},
	{.vm=vs({71,17,44,46,4,50,65,32}),.nv=61,.nsv=1,.rv=1},
	{.vm=vs({1,55,53,14,48,62,33,70,58,32,48,62,6,76,63,4,69,7,66,46,5,47,2,73,68,33,70,1,49,1,50,2,50,3,49,66,1,66,1,45,32,71,6,66,1,43,1,66,7}),.nv=62,.rv=1},
	{.vm=vs({51,2,44,65,1,75,2,71,3,75,4,44,48,61,7})},
};
