...
{{.nsv=1},
	...
	{.vm=vs({43,5,46,3,68,68,46,7,61,11,43,6,49,1,55,52,43,5,61,19,61,11,43,3,43,4,70,43,18,70,4}),.nv=10,.pv=12,.sv=1},
	{.vm=vs({61,5,46,3,56,56,1,51,44,1,51,44,7,43,5,43,6,4,46,2,44,66,66,3,70,1,75}),.nv=11}
};
			...
			while(ck)	
			{
				...
				for(size_t vk=0;vk<gv.size();vk++)
				{
					...
					for(int k=0;k<ks;k++)
					{
						...
						if(pv.vv&&pv.vv!=1&&pv.vv!=2&&!(!nv&&pv1.vv==pv.vv)&&!nv)
