...
{{.nsv=1},
	...
	{.vm=vs({51,2,49,43,3,56,7,68,53,19,50,32,49,67,5,71,3,70,1,76,49,14,51,3,44,1,76,74,1,46,31,66}),.nv=22,.pv=28},
	{.vm=vs({51,4,56,1,75,2,43,39,75,1,66,49,43,1,51,37,48,38,74,3,44,31,66}),.nv=30,.pv=25,.vv={29}},
	{.vm=vs({43,1,70,66,44,35,77,51,8,76,49,33,66,49,43,1,66,7}),.nv=24,.pv=26,.vv={29}},
	...
	{.vm=vs({66,2,49,43,6,75}),.nv=23,.nsv=1},
	{.vm=vs({}),.nsv=1},
};
