...
{{.nsv=1},
	...
	{.vm=vs({43,1,70,66,44,1,71,44,1,48,61,44,4,53,3,65,1,70,1,70,44,1,47,70,4,77,71,21,56,57,43,1,70,66,31})},
	{.vm=vs({31,46,2,76,51,2,49,43,3,56,7,68,2,71,7,71,44,1,47,70,2,49,43,38,66,66,3,44,1,76,71,2,44,36,77,51,4,44,1,43,7,48,43,1,66,31}),.nv=14},
	{.vm=vs({51,1,44,66,44,32}),.nsv=1},
};
